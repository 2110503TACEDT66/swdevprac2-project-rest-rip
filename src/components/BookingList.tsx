      ...
      {bookItems.length > 0 ? (
        bookItems.map((reservationItem) => (
          <div
            ...
            key={i}
          >
            <div className="bg-slate-500 rounded-lg p-5 text-white w-1/4 items-center flex flex-col justify-center">
              ...
              <h1 className="text-slate-200">{reservationItem.workSpace}</h1>
